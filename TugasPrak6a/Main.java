...
public class Main {
    public static void main(String[] args) {
        ...
        User[] users = UserProvider.getDataUsers();
        Category[] categories = CategoryProvider.getCategories();
        Book[] books = BookProvider.getDataBook(categories);
            ...
            while (!isLoggedIn) {
                ...
                for (User user : users) {
                    if (user.getUsername().equals(username)) {
                        ...
                        System.out.println("Username atau password anda tidak sesuai. 2");
                        break;
                    }
                }
            }
    ...
    // 2 2 2 2 2 2
    private static void viewBookDetail(Book[] books, Scanner in) {
        viewAllBooks(books);
        System.out.println("\u001B[34m+=-----------------------------------------------------------=+\u001B[0m");
        while (true) {
    ...
    // 3 3 3 3 3 3
    private static void searchByCategory(Category[] categories, Book[] books, Scanner in) {
    ...
    // 4 4 4 4 4 4
    private static void viewCurrentUser(User currentUser, Book[] books) {
    ...
    // 5 5 5 5 5 5
    private static void borrowBook(User currentUser, Book[] books, Scanner in) {
    ...
    // 6 6 6 6 6 6
    private static void returnBook(User currentUser, Book[] books, Scanner in) {
